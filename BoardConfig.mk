...
#TARGET_KERNEL_CONFIG := mk_aries_defconfig
...
TARGET_KERNEL_CUSTOM_TOOLCHAIN := arm-cortex_a15-linux-linaro-4.9
...
# PowerHAL jenly add from cm12.1
...
BOARD_BOOTIMAGE_PARTITION_SIZE     := 31457280       # 15MB
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 15728640      # 15MB
BOARD_SYSTEMIMAGE_PARTITION_SIZE   := 1073741824    # 512MB
...
# Dexopt jenly add from cm12.1
#WITH_DEXPREOPT := true
#WITH_DEXPREOPT_BOOT_IMG_ONLY := ture
#DEX_PREOPT_DEFAULT := ture
#TARGET_BUILD_VARIANT := user
#DEXPREOPT_BOOT_JARS := $(DEXPREOPT_BOOT_JARS):$(TARGET_ADDITIONAL_BOOTCLASSPATH)
#TARGET_ADDITIONAL_BOOTCLASSPATH := am.jar:core-lg.mokee.hardware.jar
